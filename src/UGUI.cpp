...
#ifndef USE_INTERNAL_FONTS
// set RA8875 fontpixel pointers
  #ifdef USE_FONT_6X8
    FONT_6X8.p = &font_6x8;
  #endif
  
  #ifdef USE_FONT_6X10
    FONT_6X10.p = &font_6x10;
  #endif
  
  #ifdef USE_FONT_7X12
    FONT_7X12.p = &font_7x12;
  #endif
  ...
  #ifdef USE_FONT_8X12
    FONT_8X12.p = &font_8x12;
  #endif
  
  #ifdef USE_FONT_8X14
    FONT_8X14.p = &font_8x14;
  #endif
  
  #ifdef USE_FONT_10X16
    FONT_10X16.p = &font_10x16;
  #endif
  
  #ifdef USE_FONT_12X16
    FONT_12X16.p = &font_12x16;
  #endif
  
  #ifdef USE_FONT_12X20
    FONT_12X20.p = &font_12x20;
  #endif
  
  #ifdef USE_FONT_14X22
    FONT_14X22.p = &font_14x22;
  #endif
  
  #ifdef USE_FONT_16X26
    FONT_16X26.p = &font_16x26;
  #endif
#endif
}
...
void UGUI::UG_PutString( UG_S16 x, UG_S16 y, char* str )
{
UG_GUI* gui = _gui;
...
#ifndef USE_INTERNAL_FONTS
  if (chr == 0x20) return;
  if( ((UG_RESULT(*)(char chr, UG_S16 x, UG_S16 y, UG_COLOR fc, UG_COLOR bc, const UG_FONT* font))gui->driver[DRIVER_PUT_CHAR].driver)(chr,x,y,fc,bc,font) == UG_RESULT_OK ) return;
#else
