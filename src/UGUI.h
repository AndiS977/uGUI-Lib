...
#define OBJ_EVENT_PREUPDATE                           6
#define OBJ_EVENT_POSTUPDATE                          7
...
/* Default Radialbutton IDs */
#define RAB_ID_0                                      OBJ_ID_0
#define RAB_ID_1                                      OBJ_ID_1
#define RAB_ID_2                                      OBJ_ID_2
#define RAB_ID_3                                      OBJ_ID_3
#define RAB_ID_4                                      OBJ_ID_4

/* Radialbutton states */
#define RAB_STATE_RELEASED                            (0<<0)
#define RAB_STATE_PRESSED                             (1<<0)
#define RAB_STATE_ALWAYS_REDRAW                       (1<<1)

/* Radialbutton style */
#define RAB_STYLE_2D                                  (0<<0)
#define RAB_STYLE_3D                                  (1<<0)
#define RAB_STYLE_TOGGLE_COLORS                       (1<<1)
#define RAB_STYLE_USE_ALTERNATE_COLORS                (1<<2)
//#define RAB_STYLE_NO_BORDERS                          (1<<3)
#define RAB_STYLE_NO_FILL                             (1<<4)

/* Radialbutton events */
#define RAB_EVENT_CLICKED                             OBJ_EVENT_CLICKED
...
/* Bargraph states */
#define PRB_STATE_ALWAYS_REDRAW                       (1<<1)

/* Bargraph style */
#define PRB_STYLE_2D                                  (0<<0)
#define PRB_STYLE_3D                                  (1<<0)
#define PRB_STYLE_NO_BORDERS                          (1<<3)
#define PRB_STYLE_NO_FILL                             (1<<4)
...
#define C_PALE_GREEN                   0x9fd3 //0x97D2
...
//typedef  void (*functiontype)  (UG_S16, UG_S16, UG_S16, UG_S16);


class UGUI {
  public:
#ifndef USE_STATIC_MEMORY
  UG_WINDOW** window = new UG_WINDOW*[_numberWindows = 1];
  
	UGUI (const UG_U8 numberWindows = 1, UG_S16 x = 320, UG_S16 y = 240 );
	UG_S16 UG_Init( void (*p)(UG_S16,UG_S16,UG_COLOR) );  //, UG_S16 x = 320, UG_S16 y = 240);
#else
  UGUI (UG_GUI* g);
	UG_S16 UG_Init( UG_GUI* g, void (*p)(UG_S16,UG_S16,UG_COLOR), UG_S16 x = 320, UG_S16 y = 240);
  UG_S16 UG_SelectGUI( UG_GUI* g );
#endif
//	UG_S16 UG_SelectGUI( UG_U8 GUI );
...
#ifndef USE_STATIC_MEMORY
  UG_WINDOW* UG_WindowCreate ( uint8_t objcnt, void* (*cb)( UG_MESSAGE* ) );
#else
  UG_WINDOW* UG_WindowCreate (UG_WINDOW* wnd, UG_OBJECT* objlst, uint8_t objcnt, void* (*cb)( UG_MESSAGE* ) );
#endif
...
#ifndef USE_STATIC_MEMORY
  UG_RESULT UG_ButtonCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT UG_ButtonCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel );
#else
  UG_RESULT UG_ButtonCreate( UG_WINDOW* wnd, UG_BUTTON* btn, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT UG_ButtonCreate( UG_WINDOW* wnd, UG_BUTTON* btn, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel );
#endif
  UG_RESULT UG_ButtonTouchEnable ( UG_WINDOW* wnd, UG_U8 id );
  UG_RESULT UG_ButtonTouchDisable ( UG_WINDOW* wnd, UG_U8 id );
  ...
  UG_RESULT UG_ButtonGetVisible( UG_WINDOW* wnd, UG_U8 id );
...
#ifndef USE_STATIC_MEMORY
  UG_RESULT UG_TextboxCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel);
  UG_RESULT UG_TextboxCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye);
#else
  UG_RESULT UG_TextboxCreate( UG_WINDOW* wnd, UG_TEXTBOX* txb, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel);
  ...
  UG_RESULT UG_TextboxGetVisible( UG_WINDOW* wnd, UG_U8 id );
...
#ifndef USE_STATIC_MEMORY
  UG_RESULT UG_CheckboxCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT UG_CheckboxCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel );
#else
  UG_RESULT UG_CheckboxCreate( UG_WINDOW* wnd, UG_CHECKBOX* chb, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT UG_CheckboxCreate( UG_WINDOW* wnd, UG_CHECKBOX* chb, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel );
#endif
  ...
  UG_RESULT UG_CheckboxTouchEnable ( UG_WINDOW* wnd, UG_U8 id );
  UG_RESULT UG_CheckboxTouchDisable ( UG_WINDOW* wnd, UG_U8 id );
  ...
  UG_RESULT UG_CheckboxGetVisible( UG_WINDOW* wnd, UG_U8 id );
...
#ifndef USE_STATIC_MEMORY
  UG_RESULT UG_RadiobuttonCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 r );
#else
  UG_RESULT UG_RadiobuttonCreate( UG_WINDOW* wnd, UG_RADIOBUTTON* rab, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 r );
#endif
  ...
  UG_RESULT UG_RadiobuttonSetChecked( UG_WINDOW* wnd, UG_U8 id, UG_U8 ch );
  UG_RESULT UG_RadiobuttonTouchEnable ( UG_WINDOW* wnd, UG_U8 id );
  UG_RESULT UG_RadiobuttonTouchDisable ( UG_WINDOW* wnd, UG_U8 id );
  UG_RESULT UG_RadiobuttonSetForeColor( UG_WINDOW* wnd, UG_U8 id, UG_COLOR fc );
  UG_RESULT UG_RadiobuttonSetBackColor( UG_WINDOW* wnd, UG_U8 id, UG_COLOR bc );
  UG_RESULT UG_RadiobuttonSetAlternateForeColor( UG_WINDOW* wnd, UG_U8 id, UG_COLOR afc );
  UG_RESULT UG_RadiobuttonSetAlternateBackColor( UG_WINDOW* wnd, UG_U8 id, UG_COLOR abc );
  UG_RESULT UG_RadiobuttonSetStyle( UG_WINDOW* wnd, UG_U8 id, UG_U8 style );
  UG_U8 UG_RadiobuttonGetChecked( UG_WINDOW* wnd, UG_U8 id );
  UG_RESULT UG_RadiobuttonGetVisible( UG_WINDOW* wnd, UG_U8 id );
  UG_COLOR UG_RadiobuttonGetForeColor( UG_WINDOW* wnd, UG_U8 id );
  UG_COLOR UG_RadiobuttonGetBackColor( UG_WINDOW* wnd, UG_U8 id );
  UG_COLOR UG_RadiobuttonGetAlternateForeColor( UG_WINDOW* wnd, UG_U8 id );
  UG_COLOR UG_RadiobuttonGetAlternateBackColor( UG_WINDOW* wnd, UG_U8 id );
  UG_U8 UG_RadiobuttonGetStyle( UG_WINDOW* wnd, UG_U8 id );
  
#ifndef USE_STATIC_MEMORY
  UG_RESULT UG_ProgressbarCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye);
  UG_RESULT UG_ProgressbarCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel);
#else
  UG_RESULT UG_ProgressbarCreate( UG_WINDOW* wnd, UG_PROGRESSBAR* bgr, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye);
  UG_RESULT UG_ProgressbarCreate( UG_WINDOW* wnd, UG_PROGRESSBAR* bgr, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye, UG_U8 rel);
#endif
  UG_RESULT UG_ProgressbarSetPercent( UG_WINDOW* wnd, UG_U8 id, UG_S8 percent);
  ...
  UG_RESULT UG_ProgressbarSet2dBorderColor( UG_WINDOW* wnd, UG_U8 id, UG_COLOR c2d );
  UG_RESULT UG_ProgressbarSetStyle( UG_WINDOW* wnd, UG_U8 id, UG_U8 style );
  UG_S8 UG_ProgressbarGetPercent( UG_WINDOW* wnd, UG_U8 id);
  UG_RESULT UG_ProgressbarGetVisible( UG_WINDOW* wnd, UG_U8 id );
  UG_COLOR UG_ProgressbarGetForeColor( UG_WINDOW* wnd, UG_U8 id);
  UG_COLOR UG_ProgressbarGetBackColor( UG_WINDOW* wnd, UG_U8 id);
  UG_COLOR UG_ProgressbarGet2dBorderColor( UG_WINDOW* wnd, UG_U8 id);
  UG_U8 UG_ProgressbarGetStyle( UG_WINDOW* wnd, UG_U8 id);
  
#ifdef USE_IMAGE
  void UG_DrawBMP( UG_S16 xp, UG_S16 yp, UG_BMP* bmp );
#ifndef USE_STATIC_MEMORY
  UG_RESULT UG_ImageCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
#else
  ...
  void UG_DriverDisable( UG_U8 type );
	...
	private:
#ifndef USE_STATIC_MEMORY
  UG_WINDOW* _windowlst = new UG_WINDOW[_numberWindows];
	UG_GUI* _gui;
  UG_GUI  guiData;
  UG_U8 _numberWindows;
#else
  UG_GUI* _gui;
#endif
//  UG_WINDOW* _window;
...
//  UG_AREA   _area;
  ...
  void _UG_SendObjectEvent(UG_WINDOW *wnd,UG_OBJECT *obj, UG_U8 event);
  UG_RESULT _UG_ObjectGetVisible( UG_WINDOW* wnd, UG_U8 id, UG_U8 type);
  UG_RESULT _UG_ObjectTouchEnable ( UG_WINDOW* wnd, UG_U8 id, UG_U8 type );

  UG_RESULT _UG_WindowDrawTitle( UG_WINDOW* wnd );
	UG_RESULT _UG_WindowClear( UG_WINDOW* wnd );
#ifndef USE_STATIC_MEMORY  
  UG_RESULT _UG_ButtonCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT _UG_TextboxCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT _UG_CheckboxCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT _UG_ProgressbarCreate( UG_WINDOW* wnd, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
#else
  UG_RESULT _UG_ButtonCreate( UG_WINDOW* wnd, UG_BUTTON* btn, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT _UG_TextboxCreate( UG_WINDOW* wnd, UG_TEXTBOX* txb, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT _UG_CheckboxCreate( UG_WINDOW* wnd, UG_CHECKBOX* chb, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
  UG_RESULT _UG_ProgressbarCreate( UG_WINDOW* wnd, UG_PROGRESSBAR* bgr, UG_U8 id, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye );
#endif
  ...
  static void* _UG_TextboxUpdate(UG_WINDOW* wnd, UG_OBJECT* obj);
	...
	static void* _UG_RadiobuttonUpdate(UG_WINDOW* wnd, UG_OBJECT* obj);
